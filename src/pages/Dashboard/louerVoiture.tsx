...
export default function LouerVoiture() {
  ...
  const [typedeLocation, setTypedeLocation] = useState("");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("typedeLocation", typedeLocation);
      ...
      <div>
        ...
        >
          <div className="space-y-4">
            ...
            <select
              value={typedeLocation}
              onChange={(e) => setTypedeLocation(e.target.value)}
              className="w-full p-3 rounded-lg bg-gray-100"
            >
              <option value="">Choisir le type de location</option>
            ...
            <Input
              ...
              type="number"
              value={count}
              onChange={(v: string) => setCount(Number(v))}
            />
